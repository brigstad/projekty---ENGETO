...
print(oddelovac)
cislo_textu = input("Zadej číslo vybraného textu (1-3): ")
if not cislo_textu.isnumeric() or int(cislo_textu) not in range(1,4):
    print ("Zadaný text neexistuje. Ukončuji.")
    exit()
